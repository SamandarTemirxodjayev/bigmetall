  ...
  <div v-if="!loading" class="mx-5">
    <div class="my-4">
      <span class="text-2xl font-semibold"
        >Hisobot - {{ seller ? seller.name : "" }} -
        {{ seller ? seller.number : "" }}</span
      >
    </div>
      ...
      <div class="flex justify-between gap-[1%]">
        ...
        >
          <div class="flex gap-2 mb-5">
            ...
            <h1 class="font-[500] text-[20px] leading-7">Savdo Aylanmasi</h1>
          </div>
        ...
        >
          <div class="flex gap-2 mb-5">
            ...
            <h1 class="font-[500] text-[20px] leading-7">Harajatlar</h1>
          </div>
          <div class="max-h-[200px] overflow-y-auto scrollbar pe-4">
            <div
              class="grid grid-cols-2 bg-[#F3F4F6] rounded-md p-2 my-2"
        ...
        >
          <div class="flex gap-2 mb-5">
            ...
            <h1 class="font-[500] text-[18px] leading-7">Foyda</h1>
          </div>
          <div class="max-h-[200px] overflow-y-auto scrollbar pe-4">
            <div
              class="grid grid-cols-2 bg-[#F3F4F6] rounded-md p-2 my-2"
...
onMounted(async () => {
  ...
  const datas = await $host.post("/cars/" + route.params.id + "/results", {
    startDate: startDate,
    endDate: endDate,
  });
